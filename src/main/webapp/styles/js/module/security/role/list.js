...
requirejs(['jquery', 'bootstrap', 'table', 'tablezn', 'tExport', 'tExportS', 'comm', 'message'],
    function () {
        ...
        var $table = $('#tableB').bootstrapTable({
            url: WEB_GLOBAL_CTX + '/console/security/role/getListAll',
            dataType: 'json',
            cache:false,
            showToggle:true,
            showExport:true,
        ...
        $('#delete').click(function () {
            ...
            $.each(objects, function () {
                $.post(WEB_GLOBAL_CTX + "/console/security/role/deleteInfo/" + this.id, function (rsp) {
                    if (rsp.successful) {
                        $.scojs_message(rsp.msg, $OK);
                        flashTable('tableB', '/console/security/role/getListAll');
                    } else {
        ...
        $('#add').click(function () {
            ...
            self.location = WEB_GLOBAL_CTX + "/console/security/role/add";
        });
        ...
        $('#modify').click(function () {
            ...
            var objects = $table.bootstrapTable('getSelections');
            $.each(objects, function () {
                self.location = WEB_GLOBAL_CTX + "/console/security/role/edit/"+this.id;
            });
        });
        ...
        $('#permission').click(function () {
            ...
            var objects = $table.bootstrapTable('getSelections');
            $.each(objects, function () {
                self.location = WEB_GLOBAL_CTX + "/console/security/role/editRolePermission/"+this.id;
            });
