requirejs(['jquery', 'bootstrap', 'table', 'tablezn', 'tExport', 'tExportS', 'base64', 'comm', 'message'],
    function () {
        ...
        var listAction = '/habit/group/member/memberList/' + groupId;
        var test = $("#groupId");
        ...
        $('#delete').click(function () {
            ...
            $.each(objects, function () {
                $.post(WEB_GLOBAL_CTX + "/habit/group/member/delete/" + this.id, function (rsp) {
                    if (rsp.successful) {
        ...
        $('#add').click(function () {
            ...
            setTimeout("window.location.href='" + WEB_GLOBAL_CTX + "/habit/group/member/add/" +groupId+"'", 1000);
        });
        ...
        $('#modify').click(function () {
            ...
            var objects = $table.bootstrapTable('getSelections');
            $.each(objects, function () {
                setTimeout("window.location.href='" + WEB_GLOBAL_CTX + "/habit/group/member/edit/" +this.id+"'", 1000);
            });
        });
