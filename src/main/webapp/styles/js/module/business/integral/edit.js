    ...
    function ($, _) {
        ...
        $('#formSubmit').formValidation({
            ...
            .on('success.form.fv', function (e) {
                ...
                $.post(WEB_GLOBAL_CTX + "/habit/integral/save", params, function (rsp) {
                    if (rsp.successful) {
                        $.scojs_message(rsp.msg, $OK);
                        $("#save").toggleClass("disabled");
                        setTimeout("window.location.href='" + WEB_GLOBAL_CTX + "/habit/integral/list/'", 1000);
                    } else {
