requirejs(['jquery', 'bootstrap', 'table', 'tablezn', 'tExport', 'tExportS', 'base64', 'comm', 'message'],
    function () {
        ...
        var listAction = '/habit/integral/integralList';
        //导出编码
        ...
        $('#delete').click(function () {
            ...
            $.each(objects, function () {
                $.post(WEB_GLOBAL_CTX + "/habit/integral/delete/" + this.id, function (rsp) {
                    if (rsp.successful) {
        ...
        $('#add').click(function () {
            ...
            self.location = WEB_GLOBAL_CTX + "/habit/integral/add/";
        });
        ...
        $('#modify').click(function () {
            ...
            var objects = $table.bootstrapTable('getSelections');
            $.each(objects, function () {
                self.location = WEB_GLOBAL_CTX + "/habit/integral/edit/" + this.id;
            });
        });
...
var statusList = [{id: '0', name: '个人成长值'}, {id: '1', name: '习惯成长值'}];
