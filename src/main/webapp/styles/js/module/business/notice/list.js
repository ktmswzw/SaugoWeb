requirejs(['jquery', 'bootstrap', 'table', 'tablezn', 'tExport', 'tExportS', 'base64', 'comm', 'message'],
    function () {
        ...
        var listAction = '/habit/notice/noticeList/'+$("#habitId").val();
        //导出编码
        ...
        $('#delete').click(function () {
            ...
            $.each(objects, function () {
                $.post(WEB_GLOBAL_CTX + "/habit/notice/delete/" + this.id, function (rsp) {
                    if (rsp.successful) {
        ...
        $('#add').click(function () {
            ...
            self.location = WEB_GLOBAL_CTX + "/habit/notice/add/"+$("#habitId").val();
        });
        ...
        $('#modify').click(function () {
            ...
            var objects = $table.bootstrapTable('getSelections');
            $.each(objects, function () {
                self.location = WEB_GLOBAL_CTX + "/habit/notice/edit/" + this.id;
            });
        });
