requirejs(['jquery', 'bootstrap', 'table', 'tablezn', 'tExport', 'tExportS', 'base64', 'comm', 'message'],
    function () {
        ...
        var listAction = '/habit/group/groupsList';
        //导出编码
        ...
        $('#delete').click(function () {
            ...
            $.each(objects, function () {
                $.post(WEB_GLOBAL_CTX + "/habit/group/delete/" + this.id, function (rsp) {
                    if (rsp.successful) {
        ...
        $('#add').click(function () {
            ...
            self.location = WEB_GLOBAL_CTX + "/habit/group/add";
        });
        ...
        $('#modify').click(function () {
            ...
            var objects = $table.bootstrapTable('getSelections');
            $.each(objects, function () {
                self.location = WEB_GLOBAL_CTX + "/habit/group/edit/" + this.id;
            });
        });
        ...
        $('#record').click(function () {
            ...
            var objects = $table.bootstrapTable('getSelections');
            $.each(objects, function () {
                self.location = WEB_GLOBAL_CTX + "/habit/group/member/list/" + this.id;
            });
        });
