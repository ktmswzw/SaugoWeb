...
import com.xecoder.business.entity.Dictionary;
import com.xecoder.business.entity.DictionaryCriteria;
import com.xecoder.business.mapper.DictionaryMapper;
import com.xecoder.business.service.DictionaryService;
...
public class DictionaryServiceImpl  extends BaseService implements DictionaryService {
    ...
    public Page findByPage(Page page, Dictionary dictionary) {
        ...
        List<Dictionary> list= baseDao.selectByPage("com.xecoder.business.mapper.DictionaryMapper."+BaseDao.SELECT_BY_EXAMPLE, getCriteria(page,dictionary),page);
        if(list!=null)
    ...
    public List<Dictionary> findAll(Page page, Dictionary dictionary) {
        return baseDao.selectList("com.xecoder.business.mapper.DictionaryMapper."+BaseDao.SELECT_BY_EXAMPLE, getCriteria(page,dictionary));
    }
    ...
    public Page findParentDicList(Page page,Dictionary dictionary){
        ...
        return page.setRows(baseDao.selectByPage("com.xecoder.business.mapper.DictionaryMapper.findParent", getCriteria(page,dictionary),page));
    }
    ...
    public Page findChildrenDicList(Page page,Dictionary dictionary){
        ...
        return page.setRows(baseDao.selectByPage("com.xecoder.business.mapper.DictionaryMapper.findChildren", getCriteria(page,dictionary),page));
    }
    ...
    public List<Dictionary> findParentAll(Page page, Dictionary dictionary) {
        return baseDao.selectList("com.xecoder.business.mapper.DictionaryMapper.findParent", getCriteria(page,dictionary));
    }
    ...
    public List<Dictionary> findChildrenAll(Page page, Dictionary dictionary) {
        return baseDao.selectList("com.xecoder.business.mapper.DictionaryMapper.findChildren", getCriteria(page,dictionary));
    }
