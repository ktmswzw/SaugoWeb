...
public class ModuleServiceImpl extends BaseService implements ModuleService {
	...
	public List<Module> find(Long parentId,String name, Page page) {
		...
		return baseDao.selectByPage("com.xecoder.mapper.ModuleMapper."+BaseDao.SELECT_BY_EXAMPLE, criteria, page);
	}
    ...
    public Page findByPage(Page page, Module module) {
        ...
        List<Module>  list = baseDao.selectByPage("com.xecoder.mapper.ModuleMapper." + BaseDao.SELECT_BY_EXAMPLE, getCriteria(page, module), page);
        if(list!=null)
