...
import com.xecoder.entity.SecurityPortalCriteria;
import com.xecoder.entity.SecurityPortalReport;
import com.xecoder.mapper.SecurityPortalMapper;
import com.xecoder.mapper.SecurityPortalReportMapper;
import com.xecoder.service.core.PortalService;
...
public class PortalServiceImpl extends BaseService implements PortalService  {
    ...
    public Page findByPage(Page page, SecurityPortal securityPortal) {
        ...
        List<SecurityPortal> list= baseDao.selectByPage("com.xecoder.mapper.SecurityPortalMapper."+ BaseDao.SELECT_BY_EXAMPLE, getCriteria(page,securityPortal),page);
        if(list!=null)
