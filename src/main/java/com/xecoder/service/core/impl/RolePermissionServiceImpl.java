...
import com.xecoder.entity.RolePermission;
import com.xecoder.entity.RolePermissionCriteria;
import com.xecoder.mapper.RolePermissionMapper;
import com.xecoder.service.core.PermissionService;
import com.xecoder.service.core.RolePermissionDataControlService;
import com.xecoder.service.core.RolePermissionService;
...
public class RolePermissionServiceImpl extends BaseService implements RolePermissionService {
    ...
    public List<RolePermission> findByRoleId(Page page,Long roleId) {
        ...
        if(page == null){
			...
			try {
				list = (List<RolePermission>)baseDao.selectByPage("com.xecoder.mapper.RolePermissionMapper." + BaseDao.SELECT_BY_EXAMPLE, criteria, page);
