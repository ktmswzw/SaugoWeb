...
import com.xecoder.entity.RoleCriteria;
import com.xecoder.mapper.RoleMapper;
...
//		shiroRealm.clearAllCachedAuthorizationInfo();
	...
	public List<Role> find(Page page, Role role) {
        if(page == null)
            ...
            List<Role> list = baseDao.selectByPage("com.xecoder.mapper.RoleMapper." + BaseDao.SELECT_BY_EXAMPLE, getCriteria(page, role), page);
            return  list;
        }
	}
